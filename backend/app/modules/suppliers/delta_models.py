...
class SupplierDeltaRun(UUIDMixin, TimestampMixin, Base):
    ...
    __table_args__ = (
        ...
        Index(
            "ix_supplier_delta_runs_source_created",
    ...
    previous_snapshot_fingerprint: Mapped[str] = mapped_column(
        String(64), nullable=False
    )
    current_snapshot_fingerprint: Mapped[str] = mapped_column(
        String(64), nullable=False
    )
    previous_schema_profile_id: Mapped[uuid.UUID] = mapped_column(
        ForeignKey("supplier_schema_profiles.id", ondelete="RESTRICT"), nullable=False
    )
    current_schema_profile_id: Mapped[uuid.UUID] = mapped_column(
        ForeignKey("supplier_schema_profiles.id", ondelete="RESTRICT"), nullable=False
    )
    previous_mapping_profile_id: Mapped[uuid.UUID] = mapped_column(
        ForeignKey("supplier_mapping_profiles.id", ondelete="RESTRICT"), nullable=False
    )
    current_mapping_profile_id: Mapped[uuid.UUID] = mapped_column(
        ForeignKey("supplier_mapping_profiles.id", ondelete="RESTRICT"), nullable=False
    )
    status: Mapped[str] = mapped_column(String(16), nullable=False)
    comparison_version: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
    idempotency_key: Mapped[str | None] = mapped_column(String(255))
    total_previous_items: Mapped[int] = mapped_column(
    ...
    price_increased_items: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0
    )
    price_decreased_items: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0
    )
    price_unchanged_items: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0
    )
    stock_increased_items: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0
    )
    stock_decreased_items: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0
    )
    became_available_items: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0
    )
    became_unavailable_items: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0
    )
    image_changed_items: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    identifier_changed_items: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0
    )
    warning_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    error_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    anomaly_signals: Mapped[list[dict[str, object]]] = mapped_column(
...
class SupplierDeltaItem(UUIDMixin, Base):
    ...
    __table_args__ = (
        ...
        Index(
            "ix_supplier_delta_items_matching_key",
            "delta_run_id",
            "matching_key_type",
            "matching_key_value",
        ),
        Index(
            "ix_supplier_delta_items_flags",
            "delta_run_id",
            "has_price_change",
            "has_stock_change",
            "has_image_change",
            "has_identifier_change",
        ),
    )
    delta_run_id: Mapped[uuid.UUID] = mapped_column(
        ForeignKey("supplier_delta_runs.id", ondelete="CASCADE"), nullable=False
    )
    ...
    previous_snapshot_item_id: Mapped[uuid.UUID | None] = mapped_column(
        ForeignKey("supplier_snapshot_items.id", ondelete="SET NULL")
    )
    current_snapshot_item_id: Mapped[uuid.UUID | None] = mapped_column(
        ForeignKey("supplier_snapshot_items.id", ondelete="SET NULL")
    )
    ...
    has_price_change: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=False
    )
    has_stock_change: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=False
    )
    has_image_change: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=False
    )
    has_identifier_change: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=False
    )
...
class SupplierDeltaFieldChange(UUIDMixin, Base):
    ...
    __table_args__ = (
        Index(
            "ix_supplier_delta_field_changes_item_path", "delta_item_id", "field_path"
        ),
    )
    delta_item_id: Mapped[uuid.UUID] = mapped_column(
        ForeignKey("supplier_delta_items.id", ondelete="CASCADE"), nullable=False
    )
