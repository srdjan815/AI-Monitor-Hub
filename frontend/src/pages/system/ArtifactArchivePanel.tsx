...
export function ArtifactArchivePanel() {
  ...
  return <Paper sx={{ p: 2.5, mt: 3 }}>
    ...
    <Stack direction="row" gap={2} my={2} flexWrap="wrap" alignItems="flex-start">
      ...
      <TextField label="Relativna putanja unutar mount-a" value={path} onChange={(event) => setPath(event.target.value)} sx={{ flex: "1 1 360px" }} helperText="Bez lozinki i apsolutne putanje" />
